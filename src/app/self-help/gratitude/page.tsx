...
import GratitudeCard from "@/components/features/self-help/GratitudeCard";
...
export default function JournallingPage() {
  return (
    <RoleGuard permissionType="student-only">
      <JournallingPageContent />
    </RoleGuard>
  );
}

function JournallingPageContent() {
    ...
    <div className="min-h-screen max-w-6xl container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-10 sm:py-16 lg:py-20">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
          Lihat sisi positif & apresiasi dirimu tiap hari
        </p>
      </div>
